...
def input_company() :
    ...
    while not 0 < c_index < 6 :
        c_index = int(input("잘못입력하셨습니다. 1~5 사이의 숫자를 입력하세요\n" + \
    ...
    c_name = ['samsung','lge','hynix','naver','hyun_car']
    name = c_name[c_index-1]
